...
import 'package:homestay_raya/models/secondTab.dart';
...
class _profileTabState extends State<profileTab> {
                            ...
                            child: GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:
                                      "${Config.SERVER}/homestayraya/mobile/assets/profileimages/${widget.user.id}.png?v=$val",
                    ...
                    children: [
                      ...
                      Expanded(
                          child: ListView(
                            ...
                            MaterialButton(
                              onPressed:
                                  isDisable ? null : _changePasswordDialog,
  ...
  void _updateProfileImage(image) {
    ...
    http.post(
        Uri.parse("${Config.SERVER}/homestayraya/mobile/php/update_profile.php"),
        body: {
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (content) => secondTab(user: user)));
              },
            ),
            TextButton(
              child: const Text(
